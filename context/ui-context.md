...
- Workspace shell reference: inset rounded three-column layout with a grid-backed central surface. Project and AI panels default open as independent desktop columns; compact screens show one overlay at a time and initially show only the canvas.
